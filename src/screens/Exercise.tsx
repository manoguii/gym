...
export function Exercise() {
  ...
  async function fetchExerciseDetails() {
    try {
      ...
      const title = isAppError
        ? error.message
        : 'Não foi possível carregar os detalhes exercício'
  ...
  async function handleExerciseHistoryRegister() {
    try {
      ...
      toast.show({
        title: 'Parabéns! Exercicio concluído com sucesso!',
        placement: 'top',
        bgColor: 'green.700',
      })
    } catch (error) {
      ...
      const title = isAppError
        ? error.message
        : 'Não foi possível marcar como concluido, tente novamente mais tarde'
